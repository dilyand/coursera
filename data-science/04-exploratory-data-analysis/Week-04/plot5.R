################################################################################
# This script creates the file plot5.png, which is a required part of the      #
...
print(paste("This script has now created a file called 'plot5.png'. Look for it in ", getwd(), "."))
